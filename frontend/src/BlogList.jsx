      ...
      if (response.ok) {
        ...
        alert("Failed to delete blog: " + data.message);
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              transition={{ delay: idx * 0.07, duration: 0.4, type: "spring", stiffness: 200, damping: 15 }}
              whileHover={{
              scale: 1.07,
              boxShadow: "0 8px 32px 0 rgba(59,130,246,0.25), 0 1.5px 8px 0 rgba(59,130,246,0.15)",
              }}
              className="relative bg-blue-50/80 dark:bg-blue-900/30 backdrop-blur-lg rounded-2xl shadow-md border border-blue-200 dark:border-blue-700 p-6 cursor-pointer transition-all duration-300"
              >
